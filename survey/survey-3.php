    ...
    <section id="guide">
      <div class="container mx-auto px-4 pt-28 lg:px-36">
        <div class="progress flex flex-row items-center mb-4">
            ...
            <p class="text-paragraph text-sm w-[2%] text-end">3/7</p>
        </div>
     ...
     <section id="button">
        <div class="container mx-auto px-4 py-3 flex flex-row justify-between gap-5 items-center lg:px-36 mt-5">
            <!-- Next -->
            <a href="./survey-2.php" class="py-3 px-8 bg-white text-darkblue border border-darkblue w-1/2 text-center hover:bg-white/80 rounded-lg">
                Kembali
            </a>
            <a href="./survey-4.php" class="py-3 px-8 bg-darkblue text-white w-1/2 text-center hover:bg-darkblue/80 rounded-lg">
                Lanjutkan
            </a>
        </div>
    </section>
