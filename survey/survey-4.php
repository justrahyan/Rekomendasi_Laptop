    ...
    <section id="guide">
      <div class="container mx-auto px-4 pt-28 lg:px-36">
        <div class="progress flex flex-row items-center mb-4">
            ...
            <p class="text-paragraph text-sm w-[2%] text-end">4/7</p>
        </div>
        <div class="guide bg-skyblue border border-slate-300 w-full flex flex-col items-start pt-8 px-5 pb-5 gap-5 rounded-lg">
            <div class="content w-full flex flex-col lg:flex-row items-start">
                <div class="text px-5 w-full lg:w-1/2 text-paragraph">
                    <h1 class="text-xl md:text-xl font-bold mb-2 lg:mb-5">Berapa ukuran layar laptop yang anda inginkan?</h1>
                </div>
                    ...
                    <form action="value-handler.php" method="POST">
                        <div class="space-y-3">
                            <label class="flex bg-gray-100 text-gray-700 rounded-md px-3 py-2 has-[:checked]:bg-darkblue has-[:checked]:text-white cursor-pointer">
                                <input type="radio" name="layar" class="hidden" value="dibawah_13">
                                <span class="pl-2">Di bawah 13 inci</span>
                            </label>
                            <label class="flex bg-gray-100 text-gray-700 rounded-md px-3 py-2 has-[:checked]:bg-darkblue has-[:checked]:text-white cursor-pointer">
                                <input type="radio" name="layar" class="hidden" value="13_sampai_14">
                                <span class="pl-2">13 - 14 inci</span>
                            </label>
                            <label class="flex bg-gray-100 text-gray-700 rounded-md px-3 py-2 has-[:checked]:bg-darkblue has-[:checked]:text-white cursor-pointer">
                                <input type="radio" name="layar" class="hidden" value="15_sampai_16">
                                <span class="pl-2">15 - 16 inci</span>
                            </label>
                            <label class="flex bg-gray-100 text-gray-700 rounded-md px-3 py-2 has-[:checked]:bg-darkblue has-[:checked]:text-white cursor-pointer">
                                <input type="radio" name="layar" class="hidden" value="diatas_16">
                                <span class="pl-2">Di atas 16 inci</span>
                            </label>
                        </div>
                    </form>
                </div>
     ...
     <section id="button">
        <div class="container mx-auto px-4 py-3 flex flex-row justify-between gap-5 items-center lg:px-36 mt-5">
            <!-- Next -->
            <a href="./survey-3.php" class="py-3 px-8 bg-white text-darkblue border border-darkblue w-1/2 text-center hover:bg-white/80 rounded-lg">
                Kembali
            </a>
            <a href="./survey-5.php" class="py-3 px-8 bg-darkblue text-white w-1/2 text-center hover:bg-darkblue/80 rounded-lg">
                Lanjutkan
            </a>
        </div>
    </section>
